...
function LoginContent() {
  ...
  const callbackUrl = checkoutSession
    ...
    <div className="w-full max-w-md">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          >
            {checkoutSession ? "Payment complete! Sign in to access your dashboard." : "Welcome back"}
          </p>
        </div>
        ...
        >
          <div>
            ...
            <input
              ...
              onFocus={(e) => (e.currentTarget.style.borderColor = "#c4947a")}
        ...
        >
          ...
          <Link
            href={checkoutSession ? `/signup?checkout_session=${checkoutSession}` : "/signup"}
